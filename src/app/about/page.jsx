  ...
  return (
    <div className='bg-white'>
      ...
      <div className="indent-8 p-8">
        ...
        <p>I am a data nerd, life-long creative and trail-runner living in Portland, Oregon with an MS in Applied Data Science from Portland State University '25.</p> 
